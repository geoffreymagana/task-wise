...
import { CheckCircle, Clock, ListTodo, Edit, Loader2, Download, Moon, Sun } from 'lucide-react';
...
import { AnalyticsCharts } from '@/components/task-manager/analytics-charts';
...
export default function ProfilePage() {
  ...
  const stats = useMemo(() => {
    ...
    const totalCompletionTime = completedTasksWithTime.reduce((acc, task) => {
        ...
        if (!startTime || !task.completedAt) return acc;
            ...
            <div className="lg:col-span-1">
                <Card className="shadow-lg">
                  <CardHeader className="flex flex-col items-center text-center">
                    <Avatar className="w-24 h-24 mb-4 flex items-center justify-center bg-primary/10 rounded-full">
                  ...
                  <CardContent>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-2 gap-4 text-center">
